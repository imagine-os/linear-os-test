...
# Column operations, grouping headers, aggregate footer and RecordPanel
...
In: `views/grid/{ColumnMenu,columns,GroupHeader,AggregateFooter,RecordPanel}.tsx`. Out: the filter, sort and group builders (PAP-166), record detail routes and history (`gap/tables/record-detail`).
