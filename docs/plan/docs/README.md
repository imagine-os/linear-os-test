...
| ADR 0005: one repository, `imagine-os/linear-os-test` (layout, history kept, Pages by Actions with hub, Blueprint and app, old repos retired; 19:57 UTC) | [`decisions/0005-one-repository-linear-os-test.md`](decisions/0005-one-repository-linear-os-test.md) |
| Build log, 19:57-20:40 UTC section: consolidation into `linear-os-test`, layout, commits, gates, the Actions no-run finding, Pages URLs, remaining old-name counts, follow-ups, old-repo disposition | [`build-log/2026-09-19.md`](build-log/2026-09-19.md) section "19:57-20:40 UTC" |
| Estimate versus actual: the round-4 cost-and-duration model against the measured autopilot run, and what remains to v0.1 (Opus 5) | [`build-log/estimate-vs-actual-2026-09-19.md`](build-log/estimate-vs-actual-2026-09-19.md) |
