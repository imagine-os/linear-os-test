...
* Consumers: PAP-254 (certification requires green `gate/dast` within 7 days), PAP-89 digest (open dynamic findings), PAP-219 (control verification `verify: test` filled by this suite), PAP-241 (calibration cross-check), PAP-356 (`scan.new_s0_finding`).
