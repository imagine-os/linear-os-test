...
* Badge: `reports/golden-path/latest.json` with median duration over the last seven runs rendered by [shields.io](<http://shields.io>) endpoint syntax into the README.
