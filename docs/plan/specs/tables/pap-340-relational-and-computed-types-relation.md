...
Provides: four types, `convertFieldType`, `conversionMatrix`, `runConversion(job)`. Consumes: framework child, compiler joins (PAP-163), jobs (PAP-43). Consumed by PAP-332.
