...
* Copy from `states.*.copy` rendered as-is until PAP-375 wraps it; `component?` overrides the default component per state.
...
Blocked by PAP-314, PAP-234. Soft: PAP-119, PAP-16, PAP-59, PAP-18.
